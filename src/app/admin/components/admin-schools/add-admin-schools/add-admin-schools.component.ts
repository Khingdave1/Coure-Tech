...
@Component({
  selector: 'app-add-admin-schools',
  templateUrl: './add-admin-schools.component.html',
  styleUrls: ['./add-admin-schools.component.scss']
})
export class AddAdminSchoolsComponent {
